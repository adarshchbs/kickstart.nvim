...
---@field b table Buffer variables
---@field w table Window variables
---@field t table Tab page variables
---@field v table Vim variables
---@field env table Environment variables
---@field opt table Options
---@field o table Global options
---@field bo table Buffer-local options
---@field fn table Vim functions
---@field cmd table Execute Vim commands
---@field api table Neovim API functions
---@field uv table|nil Neovim uv (libuv) API
---@field loop table Neovim loop API (alias for vim.uv or vim.loop)
---@field lsp table LSP functions
---@field keymap table Keymap functions
---@field highlight table Highlight functions
---@field schedule function Schedule a function to be executed soon
---@field diagnostic table Diagnostic functions
---@field fs table File system functions
---@field tbl_deep_extend function Deeply extend tables
---@field tbl_keys function Get table keys as a list
---@field list_extend function Extend a list with another list
...
'mrjones2014/smart-splits.nvim', -- NOTE: Plugins can also be added by using a table,
...
}, -- Highlight todo, notes, etc in comments
{
    ...
    opts = {
        ensure_installed = {'bash', 'python', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline',
                            'query', 'vim', 'vimdoc'},
